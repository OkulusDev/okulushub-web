...
### Итог
Чтобы быть анонимным, вам нужно соблюдать правила:

 + Используйте качественный VPN и прокси
 + Используйте Tor
 + Не раскидывайтесь информацией о себе
 + Чистите свои социальные сети
 + Используйте только анонимные браузеры
 + По возможности, не используйте JavaScript
 + Принимайте платежи не с Qiwi, а с DonationAlerts
 + Поменяй цифровой IP на буквенный
